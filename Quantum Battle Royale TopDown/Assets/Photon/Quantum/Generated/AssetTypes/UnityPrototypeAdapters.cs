...
namespace Quantum.Prototypes.Unity {
  ...
  [Quantum.Prototypes.PrototypeAttribute(typeof(Quantum.Collectible))]
  public class Collectible_Prototype : Quantum.PrototypeAdapter<Quantum.Prototypes.Collectible_Prototype> {
    public Quantum.AssetRefCollectibleConfig Config;
    [Quantum.LocalReference]
    public global::EntityPrototype TargetCharacter;
    public Photon.Deterministic.FP TimerToCollect;

    public sealed override Quantum.Prototypes.Collectible_Prototype Convert(EntityPrototypeConverter converter) {
      var result = new Quantum.Prototypes.Collectible_Prototype();
      result.Config = this.Config;
      converter.Convert(this.TargetCharacter, out result.TargetCharacter);
      result.TimerToCollect = this.TimerToCollect;
      return result;
    }
  }
  [System.SerializableAttribute()]
  [Quantum.Prototypes.PrototypeAttribute(typeof(Quantum.PlayerCharacter))]
  public class PlayerCharacter_Prototype : Quantum.PrototypeAdapter<Quantum.Prototypes.PlayerCharacter_Prototype> {
    [Quantum.LocalReference]
    public global::EntityPrototype Owner;

    public sealed override Quantum.Prototypes.PlayerCharacter_Prototype Convert(EntityPrototypeConverter converter) {
      var result = new Quantum.Prototypes.PlayerCharacter_Prototype();
  ...
  public class PlayerLink_Prototype : Quantum.PrototypeAdapter<Quantum.Prototypes.PlayerLink_Prototype> {
    ...
    [Quantum.LocalReference]
    public global::EntityPrototype Character;
    public System.Int32 DisconnectedTicks;
    ...
    public sealed override Quantum.Prototypes.PlayerLink_Prototype Convert(EntityPrototypeConverter converter) {
      ...
      converter.Convert(this.Character, out result.Character);
      result.DisconnectedTicks = this.DisconnectedTicks;
      return result;
    }
  }
  [System.SerializableAttribute()]
  [Quantum.Prototypes.PrototypeAttribute(typeof(Quantum.ProjectileFields))]
  public class ProjectileFields_Prototype : Quantum.PrototypeAdapter<Quantum.Prototypes.ProjectileFields_Prototype> {
    public Photon.Deterministic.FP TTL;
    [Quantum.LocalReference]
    public global::EntityPrototype Source;
    public Photon.Deterministic.FPVector2 Direction;
    public Photon.Deterministic.FPVector2 InitialPosition;
    public Quantum.AssetRefProjectileConfig ProjectileConfig;

    public sealed override Quantum.Prototypes.ProjectileFields_Prototype Convert(EntityPrototypeConverter converter) {
      var result = new Quantum.Prototypes.ProjectileFields_Prototype();
      result.TTL = this.TTL;
